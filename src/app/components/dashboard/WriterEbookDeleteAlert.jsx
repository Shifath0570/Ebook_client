...
export function WriterEbookDeleteAlert({bookId}) {

    const handleDeleteEbook = async () =>{
        const baseUrl = process.env.NEXT_PUBLIC_BASE_URL;
        const res = await fetch(`${baseUrl}/writerEbook/${bookId}`,{
            method: "DELETE",
            headers: {
        ...
        <AlertDialog.Container>
          <AlertDialog.Dialog >
            ...
            <AlertDialog.Footer>
              ...
              <Button onClick={handleDeleteEbook} slot="close" variant="danger">
                Delete
              </Button>
            </AlertDialog.Footer>
          </AlertDialog.Dialog>
