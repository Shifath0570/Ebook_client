...
import { TextField, Label, Input, TextArea, Select, ListBox, Button, Card, toast } from "@heroui/react";
import { motion, AnimatePresence } from "framer-motion";
import { createBooks } from "@/lib/actions/book";
    ...
    return (
        <div className="flex items-center justify-center p-4 sm:p-6 md:p-8">
            <motion.div
                ...
                <Card className="w-full bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 shadow-2xl rounded-2xl p-2 sm:p-6">

                    <Card.Header className="flex flex-col items-start gap-1 pb-4 px-6">
                        <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-violet-400 to-indigo-200 bg-clip-text text-transparent">
                            Publish to Fable
                        </h1>
                        <p className="text-sm text-slate-400">
                            Fill out the details below to add your masterwork to the catalog.
                        </p>
                    </Card.Header>
